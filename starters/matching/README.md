...
**Intelligent Mentor Matching** · Career Mentor OS

Which mentor. Rule out the impossible ones first, then rank what is left.
...
**Call it `matching` everywhere** — your repo name, your service URL, your route, and the
variable Benjamin sets when integrating you: `MATCHING_SERVICE_URL`

## Who you depend on

U-CS 3 (skills-gap) for skills.

## Who depends on you

U-CS 5 (session-value), U-CS 6 (pricing), U-CS 7 (analytics)

## Done when

No suggestion breaks a hard limit, and you measure how many lead to a second session.
...
docker build -t matching . && docker run -p 8000:8000 matching
```
