...
**QR Digital Access** · Wasaa Lifestyle

A gate pass that cannot be screenshotted and shared, and works with no network at the gate.
...
**Call it `access-pass` everywhere** — your repo name, your service URL, your route, and the
variable Benjamin sets when integrating you: `ACCESS_PASS_SERVICE_URL`

## Who you depend on

Nothing. Security work, not machine learning.
...
You demo the attack — screenshot the code and reuse it — then demo it being rejected, offline.
...
docker build -t access-pass . && docker run -p 8000:8000 access-pass
```
