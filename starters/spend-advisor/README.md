# spend-advisor  —  U-CS 38

**AI Spending Optimization** · Wasaa Lifestyle

At most three specific things a household could do differently, each with a shilling figure.
...
**Call it `spend-advisor` everywhere** — your repo name, your service URL, your route, and the
variable Benjamin sets when integrating you: `SPEND_ADVISOR_SERVICE_URL`

## Who you depend on

U-CS 37 (budget-forecast). Agree the shape with them in week one.
...
Every recommendation has a shilling figure and a reason, and you can show the accept rate.
...
docker build -t spend-advisor . && docker run -p 8000:8000 spend-advisor
```
