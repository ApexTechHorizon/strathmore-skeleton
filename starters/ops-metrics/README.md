...
**Lifestyle Analytics Dashboard** · Wasaa Lifestyle

Six numbers that tell the operations team what to do this week.
...
**Call it `ops-metrics` everywhere** — your repo name, your service URL, your route, and the
variable Benjamin sets when integrating you: `OPS_METRICS_SERVICE_URL`

## Who you depend on

Everyone — especially 37, 38, 40 and 41. Meet them all in week one.
...
Every number has a written definition and a decision, and two match when recomputed by hand.
...
docker build -t ops-metrics . && docker run -p 8000:8000 ops-metrics
```
